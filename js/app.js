                ...
                <div class="upload-container">
                    ...
                    <form id="upload-form">
                        ...
                        <div class="form-group">
                            ...
                            ${isMobile ? `
                                <div class="mobile-file-container">
                                    <input type="file" id="file-input" name="file-input" class="file-input-mobile" accept=".pdf,.jpg,.jpeg,.png" required>
                        ...
                        <button type="submit" class="btn btn-block" id="upload-submit-btn">
